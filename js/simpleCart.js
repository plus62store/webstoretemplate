...
var cart_kosong = '<div class="empty-cart"><i class="material-icons" style="font-size:45px">shopping_bag</i><span class="center"><br />Keranjang Belanja Kosong<br /><p /><a href="/">KEMBALI BELANJA</a></span></div>';
var tombolMinus = '<span class="material-icons">add_circle_outline</span>';
var tombolPlus = '<span class="material-icons">remove_circle_outline</span>';
var tombolRemove = '<span class="material-icons">remove_shopping_cart</span>';
        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                tali: function (item, column) {
                    return "<span class='item_tali' data-tali='" + item.get(column.attr) + "'>Tali " + [item.get(column.attr)] + "</span>";
                },
            ...
            simpleCart.Item._ = simpleCart.Item.prototype = {
                ...
                berat: function (val) {
                    return isUndefined(val) ? parseInt(this.get("berat", true) || 20, 10) : this.set("berat", val);
                },
                totalberat: function () {
